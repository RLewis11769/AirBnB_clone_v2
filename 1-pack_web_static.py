...
# Archive should have name web_static_<year><month><day><hour><minute><second>.tgz
...
def do_pack():
    ...
    try:
        ...
        # .tgz extension is for compressed archive of files created by "tar" command
        ...
        # -c creates new, -z filters through gzip, -v creates verbose listing, -f uses archive file
        # Creates tarball in location listed in path using all files in web_static directory
